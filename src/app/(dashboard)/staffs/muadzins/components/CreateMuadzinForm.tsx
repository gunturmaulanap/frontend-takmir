...
import { useCreateMuadzin } from "@/hooks/useMuadzins";
...
export default function CreateMuadzinForm() {
  const router = useRouter();

  // ✅ Global state - Create muadzin mutation
  const createMuadzinMutation = useCreateMuadzin();
  ...
  const onSubmit = async (data: MuadzinFormValues) => {
    try {
      toast.loading("Menyimpan data muadzin...", {
        id: "create-muadzin",
      });

      // ✅ Create muadzin - validation sudah ditangani oleh schema
      await createMuadzinMutation.mutateAsync(data);

      toast.success("Data muadzin berhasil ditambahkan!", {
        id: "create-muadzin",
      });
  ...
  return (
    <>
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Tambah Muadzin</h1>
          <p className="text-gray-600 mt-2">
            Masukkan data muadzin baru untuk masjid
          </p>
        </div>
      </div>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-6 border-t">
              <Button
                ...
                disabled={createMuadzinMutation.isPending}
              >
              ...
              <Button
                ...
                disabled={createMuadzinMutation.isPending}
              >
                {createMuadzinMutation.isPending ? (
                  <>
