...
export function MuadzinListPage({ onDelete }: MuadzinListPageProps) {
  const [currentPage, setCurrentPage] = useState(1);
  const itemsPerPage = 12;

  const {
    data: paginatedMuadzins,
    isLoading, // True hanya saat load pertama kali
    isFetching, // True setiap kali ambil data (background)
    isError,
    refetch,
  } = useMuadzins(currentPage, itemsPerPage);

  const muadzins = paginatedMuadzins?.data || [];
  const paginationMeta = paginatedMuadzins?.meta;
    ...
    <div className="space-y-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Kelola semua data muadzin masjid Anda
              </p>
            </div>
          </div>
          <Link
      ...
      {isLoading ? (
        ...
        <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
          <p className="text-red-800 mb-2">Gagal memuat data muadzin</p>
          <button
            onClick={() => refetch()}
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-start text-sm text-gray-600">
                        ...
                        <span className="leading-tight">{muadzin.alamat}</span>
                      </div>
                    </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12">
              <div className="text-center">
                ...
                <p className="text-gray-500 mb-6 max-w-md mx-auto">
                  Mulai tambahkan muadzin pertama untuk mengelola data muadzin
                  masjid.
                </p>
                <Link
                  href="/staffs/muadzins/create"
