...
export default function AsatidzsPage() {
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold text-gray-900 mb-4">
        Selamat Datang di Manajemen Asatidz
      </h1>
      <p className="text-gray-600 mb-8">
        Pilih menu di sebelah kiri untuk mengelola data asatidz masjid.
      </p>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Link href="/asatidzs/main">
          <div className="bg-white p-6 rounded-lg border border-gray-200 hover:shadow-lg hover:border-blue-200 hover:-translate-y-1 transition-all duration-300 ease-out cursor-pointer group">
            ...
            <p className="text-gray-600 mb-4 text-sm">
              Lihat dan kelola semua asatidz masjid
            </p>
